...
/***/ function(module, exports, __webpack_require__) {
	...
	var _dataparsing = __webpack_require__(159);
	...
	var RadarChart = __webpack_require__(170).Radar;

	var dispatch = _store.store.dispatch;

	function colormap(k) {
	    var i = _dataparsing.values.indexOf(k);
	    return "hsl(" + i * 360 / 9. + ", 100%, 50%)";
	}

	function GuyStack(_ref) {
	    var data = _ref.data;
	    ...
	    return _react2.default.createElement(
	        ...
	        { draggable: "true", onDragStart: function onDragStart() {
	                return dispatch({ type: "drag person", person: data });
	            }, onMouseOver: function onMouseOver() {
	                return dispatch({ type: "select person", person: data });
	            }, onMouseOut: function onMouseOut() {
	                return dispatch({ type: "deselect person" });
	            }, style: style },
	        _react2.default.createElement("span", { style: { backgroundColor: colormap(data.bestat), margin: 1.5, width: 7, height: 7, borderRadius: 5 } }),
	        Object.keys(data.values).map(function (k, i) {
	            var style = {
	...
	function Bunch(_ref2) {
	    var people = _ref2.people;

	    var numberofmain = {};
	    _dataparsing.values.forEach(function (valuename) {
	    ...
	    return _react2.default.createElement(
	        "div",
	        { className: "column", style: row },
	        _react2.default.createElement(
	            "div",
	            { className: "column column-10", style: { fontSize: 40, display: "flex", justifyContent: "center", flexDirection: "column" } },
	            people.length
	        ),
	        _react2.default.createElement(
	            "div",
	            { className: "column column-60", style: row },
	            people.length == 0 ? "Empty Group. Drag people (colored sticks) here." : people.sort(function (a, b) {
	                return 10000 * (b.level - a.level) + (b.id - a.id);
	            }).map(function (person) {
	                return _react2.default.createElement(GuyStack, { key: person.id, data: person });
	            })
	        )
	    );
	}

	function Groups(_ref3) {
	    var _Math;

	    var groups = _ref3.groups;
	    var unpicked = _ref3.unpicked;

	    var largest_skill = (_Math = Math).max.apply(_Math, _toConsumableArray(_dataparsing.values.map(function (valuename) {
	        var _Math2;

	        return (_Math2 = Math).max.apply(_Math2, _toConsumableArray(groups.map(function (group) {
	            return group.reduce(function (b, person) {
	                return b + person.values[valuename];
	            }, 0);
	        })));
	    })));
	    return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	            "div",
	            { className: "row", onDragOver: function onDragOver(e) {
	                    return e.preventDefault();
	                }, onDrop: function onDrop() {
	                    return dispatch({ type: "drop person", on: "unpicked" });
	                } },
	            _react2.default.createElement(Bunch, { people: unpicked })
	        ),
	        _react2.default.createElement(
	            "h2",
	            null,
	        ...
	        groups.length == 0 ? "No groups yet. Press ADD GROUP." : groups.map(function (group, i) {
	            return _react2.default.createElement(
	                "div",
	                { key: i, className: "row", style: { marginBottom: 10 } },
	                _react2.default.createElement(
	                    "div",
	                    { className: "column column-20" },
	                    _react2.default.createElement(RadarChart, { redraw: true, data: {
	                            labels: _dataparsing.values,
	                            datasets: [{
	                                label: "test",
	                                pointColor: "rgba(220, 220, 220, 0)",
	                                pointStrokeColor: "rgba(220, 220, 0, 0)",
	                                data: _dataparsing.values.map(function (valuename) {
	                                    return group.reduce(function (b, person) {
	                                        return person.values[valuename] + b;
	                                    }, 0);
	                                })
	                            }]
	                        }, options: {
	                ...
	                _react2.default.createElement(
	                    ...
	                    { className: "column", onDragOver: function onDragOver(e) {
	                            ...
	                            return dispatch({ type: "drop person", on: i });
	                        } },
	                    _react2.default.createElement(Bunch, { people: group })
	                ),
	                _react2.default.createElement(
	                    "div",
	                    { className: "column column-20" },
	                    _react2.default.createElement(
	                        ...
	                        { onClick: function onClick() {
	                                return dispatch({ type: "remove group", id: i });
	                            } },
	                        "Remove Group"
	                    )
	                )
	        ...
	        _react2.default.createElement(
	            "button",
	            { onClick: function onClick() {
	                    return dispatch({ type: "add group" });
	                } },
	            "Add Group"
	        )
	    );
	...
	function App(_ref4) {
	    ...
	    return _react2.default.createElement(
	                ...
	                _react2.default.createElement(
	                    ...
	                    _react2.default.createElement(
	                        ...
	                        _react2.default.createElement(
	                            "tr",
	                            null,
	                            _dataparsing.values.map(function (valuename) {
	                                return _react2.default.createElement("td", { key: valuename, style: { padding: 3, backgroundColor: colormap(valuename) } });
	                            })
	                        ),
	                        _react2.default.createElement(
	                            "tr",
	        ...
	        _react2.default.createElement(Groups, { groups: data.groups, unpicked: data.unpicked })
	    );
	}

	dispatch({ type: "load from localstorage" });
	dispatch({ type: "add people", people: _dataparsing.people_list });

	function update() {
	    _reactDom2.default.render(_react2.default.createElement(App, { data: _store.store.getState() }), document.querySelector(".container"));
	}
	_store.store.subscribe(update);
	update();
...
/***/ function(module, exports) {
	...
	var people_list = exports.people_list = raw.split("\n").map(function (row, j) {
	    ...
	    var max = 0;
	    var maxkey = 0;
	    row.split("\t").forEach(function (k, i) {
	        if (i < 3) obj[text[i]] = k;else {
	            var val = parseInt(k);
	            level += val;
	            if (val > max) {
	                max = val;
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.groupbuilding = groupbuilding;
	...
	function groupbuilding() {
	    ...
	    switch (action.type) {
	        case "add people":
	            var not_already_added = action.people.filter(function (person) {
	                return state.everyone.filter(function (other) {
	        ...
	        case "load from localstorage":
	            var b = JSON.parse(localStorage.getItem("storage"));
	            if (b) return b;else return state;
	        case "add group":
	            return save_to_localstorage(Object.assign({}, state, { groups: state.groups.concat([[]]) }));
	        case "remove group":
	            var removed = state.groups.filter(function (_, i) {
	                return i == action.id;
	            });
	            var groups = state.groups.filter(function (_, i) {
	                return i != action.id;
	            });
	        ...
	        case "drop person":
	            var notthatguy = function notthatguy(person) {
	                return person.id != state.dragging.id;
	            };
	            var groups2 = state.groups.map(function (group) {
	                return group.filter(notthatguy);
	            });
	            var unpicked = state.unpicked.filter(notthatguy);
	            var newstate = Object.assign({}, state, { groups: groups2, unpicked: unpicked });
	            if (action.on == "unpicked") newstate.unpicked.push(state.dragging);else newstate.groups[action.on].push(state.dragging);
	            return save_to_localstorage(newstate);
	        case "select person":
	            var hoverate = function hoverate(person) {
	                return Object.assign({}, person, { hover: action.person.id == person.id ? true : undefined });
	            };
	            return Object.assign({}, state, {
	                groups: state.groups.map(function (group) {
	                    return group.map(hoverate);
	                }),
	                unpicked: state.unpicked.map(hoverate)
	            });
	        case "deselect person":
	            var dehover = function dehover(person) {
	                return Object.assign({}, person, { hover: undefined });
	            };
	            return Object.assign({}, state, {
	                groups: state.groups.map(function (group) {
	                    return group.map(dehover);
	                }),
	...
	var store = exports.store = (0, _redux.createStore)(groupbuilding);
